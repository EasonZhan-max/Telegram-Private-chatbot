"""
Telegram 个人资料双向联系中转机器人

功能说明：
1. 适合把机器人链接放在 Telegram 个人资料简介 Bio 里。
2. 当个人账号不方便主动私信别人时，让对方主动点击机器人链接留言。
3. 普通用户私聊机器人，机器人会把消息转发给本人。
4. 本人回复机器人转发过来的消息，机器人会把回复发回原用户。

重要提醒：
- 这个机器人是“被动联系入口”，不是用来批量骚扰、群发广告或规避平台规则的工具。
- Telegram 机器人通常不能主动私信从未启动过机器人的用户，对方需要先点击机器人并发送 /start 或消息。
...
# 用户发送 /start 时看到的欢迎语
# 说明：这里强调“用户主动留言”，避免被理解成机器人主动打扰别人
WELCOME_TEXT = (
    "你好，这里是 Telegram 双向联系中转机器人。\n\n"
    "你可以主动发送文字、图片、视频、语音或文件，"
    "消息会自动转交给本人。\n\n"
    "本人回复后，你会在这里收到回复。"
)

# 用户消息成功转发给本人后，用户看到的提示
USER_SENT_TEXT = "消息已转交给本人，请等待回复。"
...
def help_command(message: Message) -> None:
    ...
    help_text = (
        "使用方法：\n\n"
        "1. 你主动给机器人发送消息，我会转交给本人。\n"
        "2. 支持文字、图片、视频、文件、语音、音频、贴纸等。\n"
        "3. 本人回复后，你会在这里收到回复。\n\n"
        "说明：机器人只作为双向联系中转入口，不会主动私信陌生用户。"
    )
